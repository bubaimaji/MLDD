...
output_dir = "Bangla/bangla_features_npy/Data2Vec_large_5fold"
...
# DATA2VEC MODEL
# -------------------------------------------------
MODEL_NAME = "facebook/data2vec-audio-large"   
...
# -------------------------------------------------
print("Extracting Data2Vec-Audio embeddings...\n")
...
for fold in sorted(df["fold"].unique()):
    ...
    for row in tqdm(fold_df.itertuples(), total=len(fold_df), desc=f"Fold {fold}"):
        ...
        try:
            ...
            # -------------------------------------------------
            # Mean-pooled last hidden state  → fixed-dim vector
            # -------------------------------------------------
...
print("\nData2Vec feature extraction complete!")
