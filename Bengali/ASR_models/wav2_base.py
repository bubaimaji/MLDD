...
import torch
import torchaudio
from transformers import Wav2Vec2FeatureExtractor, Wav2Vec2Model, AutoFeatureExtractor
...
output_dir = "Bangla/bangla_features_npy/Wav2Vec2_large_5fold"
...
# WAV2VEC2 MODEL
# -------------------------------------------------
MODEL_NAME = "facebook/wav2vec2-large-960h"    # Change to your preferred model
...
print("\nWav2Vec2 feature extraction complete!")
