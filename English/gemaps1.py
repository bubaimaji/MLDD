...
OUTPUT_DIR = f"{BASE_DIR}/English/edic_features_npy/eGEMAPS_functionals/{SPLIT}"
...
print("Loaded openSMILE eGemaps Functionals \n")
...
print(f"Feature shape: {segment_feats.shape}  (segments × 1582)")
