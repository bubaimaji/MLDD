...
BASE = "/home/bubai-maji/bubai/English/edic_features_npy/whisper_small"
...
for run in range(runs):
    ...
    X_dev,   y_dev,   spk_dev   = load_split("test")
    ...
    print(f"SPEAKER PERFORMANCE (Run {run+1}) "
      f"Acc={acc:.3f}, F1={f1:.3f}, WF1={wf1:.3f}, AUC={auc:.3f}, UA={ua:.3f}")
